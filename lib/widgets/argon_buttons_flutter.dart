...
final bb = new ScreenUtil().setWidth(588);
...
class _ArgonButtonState extends State<ArgonButton>
  ...
  Widget buttonBody() {
    ...
    var color = widget.color == null ? ColorUtils.lightAccent : widget.color;
    ...
    return Container(
      ...
      child: ButtonTheme(
        ...
        child: RaisedButton(
            ...
            child: btn == ButtonState.Idle ? child : loader),
      ),
    );
  }
}
